class Recipe < ApplicationRecord
  ...
  has_one_attached :image do |attachable|
    attachable.variant :card, resize_to_fill: [ 640, 360 ], preprocessed: true
    attachable.variant :preview, resize_to_limit: [ 960, 960 ]
  end
  has_one_attached :cuisine_flag do |attachable|
    attachable.variant :thumb, resize_to_fill: [ 48, 32 ], preprocessed: true
    attachable.variant :preview, resize_to_limit: [ 160, 100 ]
  end
